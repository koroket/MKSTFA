...
- (void)viewDidLoad
{
    ...
    _pickerData = @[@"Card Search Options",@"Restaurants", @"Quick Eats", @"Bars", @"NightLife", @"Coffee & Breakfast"];
       ...
       inComponent:(NSInteger)component
{
    ...
    //[[NSUserDefaults standardUserDefaults] objectForKey:@"Search Setting"] = _pickerData[row];
